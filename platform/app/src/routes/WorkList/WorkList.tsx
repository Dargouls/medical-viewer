...
function WorkList({
	...
	const tableDataSource = sortedStudies.map((study, key) => {
		...
		const { studyInstanceUid, accession, modalities, instances, description, mrn, patientName, date, time } =
			study;
		const studyDate =
			date &&
		...
		return {
			...
			expandedContent: (
				<StudyListExpandedRow
					seriesTableColumns={{
						description: t('StudyList:Descrição'),
						seriesNumber: t('StudyList:Séries'),
						modality: t('StudyList:Modalidade'),
						instances: t('StudyList:Instâncias'),
					}}
